...
create table if not exists "public"."knowledge_base" (
    ...
    "content" text, -- Made optional
    "fileName" text not null,
    "fileType" text not null,
    "fileSize" bigint not null,
    "uploadedBy" text not null, -- Changed to text for now, can be user ID or email
    "processingStatus" text not null check (processingStatus in ('pending', 'processing', 'completed', 'failed')),
    "error" text,
...
create table if not exists "public"."transcripts" (
    ...
    "fileType" text not null,
    "fileSize" bigint not null,
    "uploadedBy" text not null, -- Changed to text for now
    "processingStatus" text not null check (processingStatus in ('pending', 'processing', 'completed', 'failed')),
    "error" text,
    "embedding" vector(1536)
);
